...
public class NWSFB05
{
        ...
        else
        {
            ...
            else
            {
                ...
                if (intAltWea>36)
                {
                    ...
                    strRet=Integer.toString(intAltWea)+"0 degrees";
                }
                else
                {
                    //return the first two characters with a "0" suffix
                    strRet=strAltWea.substring(0,2)+"0 degrees";
                }
            }
        }
        //// Return the string to the caller
        ...
        else
        {
            ...
            else
            {
                ...
                if (intAltWea>36)
                {
                    ...
                    strRet=Integer.toString(intSpeed)+" knots";
                }
                else
                {
                    //// return the second two characters of the altitude weather
                    strRet=strAltWea.substring(2,4)+" knots";
                }
            }
        }
        return strRet;
    ...
    public String getWindTemp(String strLine,String strAlt)
    {
        ...
        else
        {
            ...
            {
                //the last three
                strRet=strAltWea.substring(4,7)+"C";
            }else
            {
                // the altitude is over 24000 feet, add a "-" as a prefix
                strRet="-"+strAltWea.substring(4,6)+"C";
            }
        }
        return strRet;
    }
